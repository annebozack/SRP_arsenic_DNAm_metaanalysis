...
setwd("/Users/annebozack/Documents/Navas/S2_121611_run_2")
...
mFilter450 = rmSNPandCH(Mcombat, dist = 2, mafcut = 0.05, and = TRUE, rmcrosshyb = TRUE, rmXY=FALSE)
dim(mFilter450)
# 408765     48

# Exposure variable
pheno450$highAs[pheno450$expGroup == 1] = 1
pheno450$highAs[pheno450$expGroup == 0] = 0
pheno450$highAs = as.factor(pheno450$highAs)
```


```{r, warning=FALSE,message=FALSE,eval=FALSE}
# Check Aligment
all(pheno450$Sample_Name==colnames(mFilter450))
all(identical(pheno450$Sample_Name,colnames(mFilter450)))
# TRUE
...
```{r, warning=FALSE,message=FALSE,eval=FALSE}
modCD8T = lm(CD8T ~ highAs + age + Cig.Ever, data = pheno450)
modCD4T = lm(CD4T ~ highAs + age + Cig.Ever, data = pheno450)
modNK = lm(NK ~ highAs + age + Cig.Ever, data = pheno450)
modBcell = lm(Bcell ~ highAs + age + Cig.Ever, data = pheno450)
modMono = lm(Mono ~ highAs + age + Cig.Ever, data = pheno450)
modGran = lm(Gran ~ highAs + age + Cig.Ever, data = pheno450)
```
...
```{r, warning=FALSE,message=FALSE,eval=FALSE}
# Unadjusted
modUnadjCat = model.matrix(~ pheno450$highAs)
                 
# Adjusted for age and smoking      
modAgeSmCat = model.matrix(~ pheno450$highAs + pheno450$age + pheno450$Cig.Ever)   
                   
# Adjusted for cell type, age, smoking
modCellAgeSmCat = model.matrix(~ pheno450$highAs + pheno450$CD8T + pheno450$CD4T + pheno450$NK + pheno450$Bcell + pheno450$Mono + pheno450$Gran + pheno450$age + pheno450$Cig.Ever)       
...
```{r, warning=FALSE,message=FALSE,eval=FALSE}
# Unadjusted
DMP_u_450 <- run_DMP(mvals = mFilter450, design = modUnadjCat)

table(DMP_u_450$P.Value < 0.05)
#  FALSE   TRUE 
# 358343  50422

table(DMP_u_450$adj.P.Val < 0.05)
 # FALSE   
# 408765 

table(DMP_u_450$adj.P.Val.bonf < 0.05)
 # FALSE   
# 408765


DMP_ageSmSex_450 <- run_DMP(mvals = mFilter450, design = modAgeSmCat)

table(DMP_ageSmSex_450$P.Value < 0.05)
 # FALSE   TRUE 
# 356926  51839 

table(DMP_ageSmSex_450$adj.P.Val < 0.05)
# FALSE   
# 408765

table(DMP_ageSmSex_450$adj.P.Val.bonf < 0.05)
 # FALSE   
# 408765



DMP_cellAgeSmSex_450 <- run_DMP(mvals = mFilter450, design = modCellAgeSmCat)

table(DMP_cellAgeSmSex_450$P.Value < 0.05)
 # FALSE   TRUE 
# 388852  19913 

table(DMP_cellAgeSmSex_450$adj.P.Val < 0.05)
 # FALSE   
# 408765 

table(DMP_cellAgeSmSex_450$adj.P.Val.bonf < 0.05)
 # FALSE   
# 408765 


DMP_u_450$N = 48
write.table(DMP_u_450, file = "/Users/annebozack/Documents/arsenic_meta/generic-metal/FACT_DMP_AsCategorical_unadj_450k_092520.txt", sep = "\t", row.names = FALSE, col.names = TRUE)

DMP_ageSmSex_450$N = 48
write.table(DMP_ageSmSex_450, file = "/Users/annebozack/Documents/arsenic_meta/generic-metal/FACT_DMP_AsCategorical_adjAgeSm_450k_092520.txt", sep = "\t", row.names = FALSE, col.names = TRUE)

DMP_cellAgeSmSex_450$N = 48
write.table(DMP_cellAgeSmSex_450, file = "/Users/annebozack/Documents/arsenic_meta/generic-metal/FACT_DMP_AsCategorical_adjCellAgeSm_450k_092520.txt", sep = "\t", row.names = FALSE, col.names = TRUE)
```
...
DVP_u_450 <- run_DVP(mvals = mFilter450, design = modUnadjCat)

table(DVP_u_450$P.Value < 0.05)
 # FALSE   TRUE 
# 385941  22824 

table(DVP_u_450$Adj.P.Value < 0.05)
 # FALSE   TRUE 
# 408761      4  

table(DVP_u_450$Bonferroni < 0.05)
 # FALSE   TRUE 
# 408762      3 


DVP_ageSmSex_450 <- run_DVP(mvals = mFilter450, design = modAgeSmCat)

table(DVP_ageSmSex_450$P.Value < 0.05)
 # FALSE   TRUE 
# 386024  22741 

table(DVP_ageSmSex_450$Adj.P.Value < 0.05)
 # FALSE   TRUE 
# 408760      5 

table(DVP_ageSmSex_450$Bonferroni < 0.05)
 # FALSE   TRUE 
# 408762      3



DVP_cellAgeSmSex_450 <- run_DVP(mvals = mFilter450, design = modCellAgeSmCat)

table(DVP_cellAgeSmSex_450$P.Value < 0.05)
 # FALSE   TRUE 
# 390447  18318 

table(DVP_cellAgeSmSex_450$Adj.P.Value < 0.05)
 # FALSE   TRUE 
# 408762      3 

table(DVP_cellAgeSmSex_450$Bonferroni < 0.05)
 # FALSE  
# 408765


DVP_u_450$N = 32
write.table(DVP_u_450, file = "/Users/annebozack/Documents/arsenic_meta/generic-metal/FACT_DVP_AsCategorical_unadj_450k_092520.txt", sep = "\t", row.names = FALSE, col.names = TRUE)

DVP_ageSmSex_450$N = 32
write.table(DVP_ageSmSex_450, file = "/Users/annebozack/Documents/arsenic_meta/generic-metal/FACT_DVP_AsCategorical_adjAgeSm_450k_092520.txt", sep = "\t", row.names = FALSE, col.names = TRUE)

DVP_cellAgeSmSex_450$N = 32
write.table(DVP_cellAgeSmSex_450, file = "/Users/annebozack/Documents/arsenic_meta/generic-metal/FACT_DVP_AsCategorical_adjCellAgeSm_450k_092520.txt", sep = "\t", row.names = FALSE, col.names = TRUE)
```


### QQ plot, DVPs, categorized As adjusted for cell type, age, and smoking
```{r, out.width = '75%'}
gg_qqplot(DVP_cellAgeSmSex_450$P.Value)
```

### Volcano plot, DVPs, categorized As adjusted for cell type, age, and smoking
```{r, out.width = '75%'}
volcano(DVP_cellAgeSmSex_450, type = 'DVP')
```

### Manhattan plot, DVPs, categorized As adjusted for cell type, age and smoking
```{r, out.width = '100%'}
manhattan(DVP_cellAgeSmSex_450, Locations, type = 'DVP')
```
